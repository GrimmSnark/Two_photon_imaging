function experimentStructure = doAnalysisCalciumV3(experimentStructure, prestimTime, channel2Use ,behaviouralResponseFlag)
...
for y = 1:experimentStructure.cellCount
    [ experimentStructure.correctedF(y,:), experimentStructure.neuropCorrPars{y}]=estimateNeuropil(experimentStructure.rawF(y,:),experimentStructure.rawF_neuropil(y,:)); % neuropil subtraction calculated from Dipoppa et al 2018
end
